...
interface BlogEditProps {
  post: BlogPost;
  onClose: () => void;
  onUpdate: (id: string, updatedPost: Omit<BlogPost, 'id' | 'createdAt'>) => void;
}

export default function BlogEdit({ post, onClose, onUpdate }: BlogEditProps) {
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              <div>
                <label className="block text-[#ededed] mb-2 font-['Inter:Medium',sans-serif]">
                  Please enter password to edit content
                </label>
                <input
                  type="password"
                  value={password}
